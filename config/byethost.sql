-- Create the database with Byethost-compatible naming
CREATE DATABASE IF NOT EXISTS b9_39771656_career_platform DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE b9_39771656_career_platform;
...
-- Note: Triggers are commented out as Byethost may not support them
/*
DELIMITER //
...
CREATE TABLE IF NOT EXISTS forum_comment (
    ...
    FOREIGN KEY (parent_comment_id) REFERENCES forum_comment(comment_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
