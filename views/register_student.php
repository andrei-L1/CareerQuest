...
<body>
    <div class="card p-4 shadow-lg" style="width: 400px;" data-aos="fade-up" data-aos-duration="1000">
        ...
        <h6 class="text-center">Register as a Student</h6>
        ...
        <p class="text-center mt-3">Not a Student? <a href="register_user.php">Create an Account here</a></p>
        <p class="text-center mt-2"><a href="../index.php">Back to Home</a></p>
        <p class="text-center mt-3">Already have an account? <a href="../auth/login_student.php">Login here</a></p>
    </div>
