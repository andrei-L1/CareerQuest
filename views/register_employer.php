...
<head>
    ...
    <title>Sign Up | Professional Portal</title>
...
<body>
    <div class="signup-container" data-aos="fade-up" data-aos-duration="1000">
        <div class="signup-header">
            ...
            <p>Register as an Employer/Professional</p>
        </div>
        ...
        <form method="POST" action="../controllers/signup_handler.php" id="signupForm">
            ...
            <div id="step-1">
                ...
                <input type="hidden" id="entity" name="entity" value="employer">
            ...
            <div id="step-3" class="d-none">
                <h5 class="step-title">Employer Details</h5>
                
                <div class="form-group">
                    <i class="fas fa-user-tag form-icon"></i>
                    <select name="role_id" class="form-control" style="padding-left: 3rem;" readonly>
