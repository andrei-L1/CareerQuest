...
try {
    ...
    $job_query = "SELECT title, description, location, job_type_id, salary, img_url 
                  FROM job_posting 
    ...
    $duplicate_query = "INSERT INTO job_posting 
                        (employer_id, title, description, location, job_type_id, salary, img_url, posted_at, moderation_status)
                        VALUES (:employer_id, :title, :description, :location, :job_type_id, :salary, :img_url, NOW(), 'Pending')";
    ...
    $duplicate_stmt->bindParam(':salary', $original_job['salary']);
